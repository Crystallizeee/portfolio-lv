    ...
    <div x-data="chatWidget" class="fixed bottom-8 right-8 z-50">
        ...
        >
            ...
            <div class="flex items-center justify-between px-4 py-3 bg-slate-900/80 border-b border-slate-700/50">
                ...
                <button @click="isOpen = false" aria-label="Close chat" class="p-1.5 hover:bg-slate-700/50 rounded-lg transition-colors">
                ...
                <template x-for="(msg, i) in messages" :key="i">
                    <div :class="msg.role === 'user' ? 'flex justify-end' : 'flex justify-start'">
                        <div 
                            ...
                            x-html="msg.role === 'bot' ? DOMPurify.sanitize(marked.parse(msg.text)) : msg.text"
                        ></div>
                    </div>
                </template>
