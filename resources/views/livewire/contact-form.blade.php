<section id="contact" class="py-20 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <!-- Email -->
            <a href="mailto:{{ $user->email }}" class="glass-card p-6 group hover:translate-y-[-5px] transition-all duration-300 border border-slate-700/50 hover:border-cyan-500/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:rounded-xl">
            ...
            <!-- LinkedIn -->
            @if($user->linkedin)
            <a href="{{ $user->linkedin }}" target="_blank" class="glass-card p-6 group hover:translate-y-[-5px] transition-all duration-300 border border-slate-700/50 hover:border-blue-500/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-blue-400 focus-visible:rounded-xl">
            ...
            <!-- GitHub -->
            @if($user->github)
            <a href="{{ $user->github }}" target="_blank" class="glass-card p-6 group hover:translate-y-[-5px] transition-all duration-300 border border-slate-700/50 hover:border-purple-500/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-purple-400 focus-visible:rounded-xl">
