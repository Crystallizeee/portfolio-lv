                    ...
                    <div class="p-6">
                        <form wire:submit="save" class="space-y-4">
                            ...
                            <div class="flex justify-end space-x-3 pt-4 border-t border-slate-800">
                                ...
                                <button 
                                    type="submit"
                                    class="px-6 py-2.5 bg-gradient-to-r from-cyan-500 to-blue-600 rounded-xl text-white font-medium hover:from-cyan-400 hover:to-blue-500 transition-all duration-200 shadow-lg shadow-cyan-500/25 disabled:opacity-50 disabled:cursor-wait"
                                    wire:loading.attr="disabled"
                                    wire:target="save"
                                >
                                    <span wire:loading.remove wire:target="save">{{ $isEditing ? 'Update Application' : 'Track Application' }}</span>
