<div class="flex items-center space-x-2">
    <button wire:click="toggleLike" 
        ...
        <span class="sr-only">{{ $hasLiked ? 'Unlike post' : 'Like post' }}</span>
        ...
        <span class="sr-only">, current likes: {{ $likesCount }}</span>
        <span class="font-medium font-mono text-sm" aria-hidden="true">{{ $likesCount }}</span>
    </button>
</div>
