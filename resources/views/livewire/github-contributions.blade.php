                ...
                <div class="min-w-[750px]">
                    ...
                    <div class="flex items-center justify-between mt-4">
                        <a href="https://github.com/{{ config('services.github.username') }}" 
                           ...
                           class="text-xs font-mono text-slate-500 hover:text-cyan-400 focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900 rounded-sm transition-colors flex items-center space-x-2">
