                            ...
                            <div x-data="{ expanded: false }" class="mb-6">
                                ...
                                @if(strlen($cert->description) > 120)
                                    <button @click="expanded = !expanded"
                                            ...
                                            class="text-xs text-yellow-500 hover:text-yellow-400 mt-1.5 font-medium transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 rounded-sm">
                        ...
                        <div class="mt-auto pt-4 border-t border-slate-700/50 flex flex-col space-y-3">
                            ...
                            @if($cert->credential_url)
                                <a 
                                    ...
                                    class="inline-flex items-center justify-center w-full px-4 py-2 bg-slate-800 hover:bg-yellow-500/20 text-slate-300 hover:text-yellow-400 border border-slate-700 hover:border-yellow-500/50 rounded-lg text-sm font-medium transition-all duration-300 group/btn focus:outline-none focus-visible:ring-2 focus-visible:ring-yellow-500 focus-visible:ring-offset-2 focus-visible:ring-offset-slate-900"
                                >
