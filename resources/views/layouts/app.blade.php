    ...
    <nav x-data="{ mobileMenuOpen: false }" class="fixed top-0 left-0 right-0 z-50 glass-card border-b border-slate-700/50" aria-label="Main navigation">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <div class="hidden md:flex items-center space-x-8">
                    <a href="{{ route('home') }}#about" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">About</a>
                    <a href="{{ route('home') }}#experience" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">Experience</a>
                    <a href="{{ route('home') }}#lab" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">Home Lab</a>
                    <a href="{{ route('home') }}#projects" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">Projects</a>
                    <a href="{{ route('blog.index') }}" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">Blog</a>
                    <a href="{{ route('home') }}#contact" class="text-slate-400 hover:text-cyan-400 transition-colors font-medium focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400 rounded-sm">Contact</a>
                </div>
        ...
        >
            <div class="px-4 pt-2 pb-4 space-y-1">
                <a href="{{ route('home') }}#about" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">About</a>
                <a href="{{ route('home') }}#experience" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">Experience</a>
                <a href="{{ route('home') }}#lab" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">Home Lab</a>
                <a href="{{ route('home') }}#projects" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">Projects</a>
                <a href="{{ route('blog.index') }}" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">Blog</a>
                <a href="{{ route('home') }}#contact" @click="mobileMenuOpen = false" class="block px-3 py-2 rounded-md text-base font-medium text-slate-400 hover:text-cyan-400 hover:bg-slate-800/50 transition-all focus:outline-none focus-visible:ring-2 focus-visible:ring-cyan-400">Contact</a>
